...
<form method='post' id='emp-SaveForm' action="#">
   <table class='table table-bordered'>
      ...
      <tr>
         <td>Aircrew ID</td>
         <td>
            <select class="select form-control" name="AircrewID">
      ...
      <tr>
         ...
         <td>
            <select class="select form-control" name="PreviousAirport">
               <option> Select Previous Airport</option>
               <?php
                  mysql_connect('sql1.njit.edu', 'ap725', 'goober83');
                  mysql_select_db('ap725');
      ...
      <tr>
         ...
         <td>
            <select class="select form-control" name="DestinationAirport">
      ...
      <tr>
         <td>Aircraft Type</td>
         <td>
            <select id="AircraftType" name ="AircraftType" class="select form-control" required="required" onchange="showForm()">
      ...
      <tr>
         <td>Fuel</td>
         <td><input type='number' data-maxsize="5" name='Fuel' class='form-control'  placeholder='EX : 5000' required></td>
      </tr>
      <tr>
         <td>SkidID</td>
         <td>
            <select class="select form-control" id="SkidID" name="SkidID">
               <option> Select SkidID</option>
               <?php
                  mysql_connect('sql1.njit.edu', 'ap725', 'goober83');
                  mysql_select_db('ap725');
